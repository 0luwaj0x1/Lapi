...
function startServer() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            app = (0, express_1.createServer)();
            server = http_1.default.createServer(app).listen({ host: host, port: port }, function () {
                var addressInfo = server.address();
                logger_1.logger.info("Server ready at http://".concat(addressInfo.address, ":").concat(addressInfo.port));
            });
            signalTraps = ['SIGTERM', 'SIGINT', 'SIGUSR2'];
            signalTraps.forEach(function (type) {
                process.once(type, function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        logger_1.logger.info("process.once ".concat(type));
